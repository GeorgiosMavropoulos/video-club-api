 ...
 export default function MovieDisplay({movie}:MovieProps){
    ...
    return (
        ...
        ///implement tailwind class names
            <div className=" max-w-sm rounded-xl overflow-hidden shadow-lg border border-gray-200  bg-[#FFFDD0] p-4">
        ...
        <h1 className="text-xl font-bold text-green-900 mb-2 truncate">
          {movie.title}
        </h1>

        {/* Movie's plot */}
         <p className="text-sm text-black-900 text-gray-600 line-clamp-3 mb-4">
          {movie.plot}
        </p>


        {/*Movie's director*/}
         <h1 className="text-sm text-black-900 text-gray-600 line-clamp-3 mb-4">
          {movie.director}
        </h1>
